...
class CCPay
{
    ...
    public static $urls = [
        ...
        "SupportToken" => "https://ebc65a6dtestpaymentadmin.cwallet.com/ccpayment/v1/support/token",
        "TokenChain" => "https://admin.ccpayment.com/ccpayment/v1/token/chain",
        "TokenRate" => "https://ebc65a6dtestpaymentadmin.cwallet.com/ccpayment/v1/token/rate",
        "Withdraw" => "https://admin.ccpayment.com/ccpayment/v1/withdraw",
        "CheckUser" => "https://ebc65a6dtestpaymentadmin.cwallet.com/ccpayment/v1/check/user",
        "Assets" => "https://ebc65a6dtestpaymentadmin.cwallet.com/ccpayment/v1/assets",
        "NetworkFee" => "https://ebc65a6dtestpaymentadmin.cwallet.com/ccpayment/v1/network/fee",
    ];
    ...
    * }
     ...
     * @throws ErrorException
     */
    public static function CheckUrlWithRSA(array $originData, string $privateFile, string $appId, string $appSecret)
    {
        // 参数验证
        ...
        $resource = self::getCheckUrlSignStr($data, $appSecret);
        ...
        // 发起请求
        return self::SendRequest(self::$urls["CheckUrl"], $data);
    }
